...
function navToggle(event) {
    if (!event.target.classList.contains('active')) {
        ...
        gsap.to('.line1', 0.6, { rotate: '45deg', y: 5, background: 'black' })
        gsap.to('.line2', 0.6, { rotate: '-45deg', y: -5, background: 'black' })
        ...
        gsap.to('.line1', 0.6, { rotate: '0deg', y: 0, background: '#fff' })
        gsap.to('.line2', 0.6, { rotate: '0deg', y: 0, background: '#fff' })
